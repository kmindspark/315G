...
#pragma config(Motor,  port2,           claw,            tmotorVex393HighSpeed_MC29, openLoop) //Power expander and Y cable
#pragma config(Motor,  port3,           dl,            tmotorVex393HighSpeed_MC29, openLoop) //Power expander and Y cable
...
#pragma config(Motor,  port8,           dr,            tmotorVex393HighSpeed_MC29, openLoop, reversed) //Power expander and Y cable
...
task drive(){
	...
	while (true){
		...
		motor[df] = currentDrivePowerL;
		motor[db] = currentDrivePowerL;
		motor[pf] = currentDrivePowerR;
		motor[pb] = currentDrivePowerR;
